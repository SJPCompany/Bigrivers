...
<div class="content-wrapper">
    ...
    <section>
        <div class="divform">
            <header>
                <h1 class="headerform">Delete gebruiker</h1>
            </header>
            ...
            <form action="<?= base_url("backend/user/deleteUser"); ?>" method="post">
                <?php foreach ($checkUserInfo as $userinfo) { ?>
                    <input type="hidden" name="id" value="<?= $userinfo->id ?>">
                    <label>Gebruikersnaam:</label>
                    <input type="text" name="username" readonly value='<?= $userinfo->username ?>'><br>
                    <label>Wachtwoord:</label>
                    <input type="text" name="password" readonly value="<?= $userinfo->password ?>"><br>
                    <label>Emailadres:</label>
                    <input type="text" name="email" readonly value='<?= $userinfo->email ?>'><br>
                    <label>Selecteer rol:</label>
                    <select class="select" name="role" readonly disabled>
